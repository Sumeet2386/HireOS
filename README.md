...
### Stage 4.5 — Cross-Encoder Reranking (100 candidates)
...
### Stage 5 — Reasoning Generation (100 candidates)
...
| ChatGPT (GPT-4o-mini) | Weak label generation during offline pre-computation only (2,000 candidates, ~$1.50 total cost) |
